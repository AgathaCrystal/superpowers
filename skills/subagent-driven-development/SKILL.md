...
digraph when_to_use {
    ...
    "Stay in this session?" -> "executing-plans" [label="no - execution handoff"];
}
```

**vs. Executing Plans (execution handoff):**
...
Final reviewer: All requirements met, implementation complete.
...
- **superpowers:executing-plans** - Use for execution handoff instead of same-session execution
